...
#        Manikanta Innamuri (APFE1786134)
#        Shaibal Nandy Mazumdar (DDA1740131)
#        Neha Warthi (APFE1786855)
#        
# ------------------------------------------------------
# Date : 27th May, 2018
...
input_data <- cbind(subset(input_data, select = -c(PerformanceRating)), dummy[,-1])
